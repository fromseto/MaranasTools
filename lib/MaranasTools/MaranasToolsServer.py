...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'MaranasTools'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from MaranasTools.MaranasToolsImpl import MaranasTools  # noqa @IgnorePep8
impl_MaranasTools = MaranasTools(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'MaranasTools'
        ...
        self.rpc_service.add(impl_MaranasTools.run_optstoic,
